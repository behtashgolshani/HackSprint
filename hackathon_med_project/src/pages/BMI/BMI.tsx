      ...
      <div className={style.content}>
        ...
        <div style={{ textAlign: "center" }}>
          ...
          <p className={style.normal}>
            {" "}
            The Body Mass Index measures the relationship between your height to
            weight to determine if you are healthy. Use our BMI calculator to
          ...
          <div style={{ textAlign: "center" }}>
            ...
            <p>
              {" "}
              {disableSearch ? bmiCalculate(heightValue, weightValue) : ""}
            </p>
            <h3 style={{ color: "#004DCF" }}>
              {underweightSensor ? "You are considered underweight" : ""}
            </h3>
          ...
          <p className={style.disclaimer}>
            {" "}
            Be aware that the BMI is not an accurate indicator of how healthy
            you are. It does not factor your age, how muscular you are, your
            ethnicity, your gender and many others… If you are worried about
            your well-being please consult your trusted health practitioner.
            Additionally, if you are not feeling well during these difficult
            times visit{" "}
            <a href={"https://www.beyondblue.org.au/"}>Beyond Blue</a>.
          </p>
          <h2 style={{ textAlign: "center" }}>
            {enableSearch ? "Please enter your details" : ""}
          </h2>
