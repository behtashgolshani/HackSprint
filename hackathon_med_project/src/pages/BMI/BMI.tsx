    ...
    <div className={appStyle.body}>
      ...
      <div className={style.content}>
        ...
        <p className={style.disclaimer}>
          ...
          are. It does not factor your age, how muscular you are, your
          ethnicity, your gender and many others… If you are worried about your
          well-being please consult your trusted health practitioner.
